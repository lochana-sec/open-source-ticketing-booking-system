...
<div id="content">
  ...
  <table width="80%" border="0" align="center">
    ...
    <button class="btn btn-primary"><i class="glyphicon glyphicon-user">
    </i> Add User</button>
    </a>
    &nbsp;
...
&nbsp;
      ...
      class="table table-hover">
       ...
       ?>
	    <tr>
          ...
          &nbsp;</td>
          <td>
 <!-- <a href="edituser.php?user_id=
 <?php // echo $row['user_id']; ?>" rel="facebox">
   <button class="btn btn-primary" type="button">
          <i class="glyphicon glyphicon-edit 
          icon-write"></i> Edit</button>
          </a>&nbsp; -->
 ...
 <a href="deleteuser.php?user_id=
 <?php echo $row['user_id']; ?>" 
 onClick="return del('a User?')" >
   <button class="btn btn-danger" type="button">
          <i class="glyphicon glyphicon-trash 
          icon-write"></i> Delete</button>
          </a>
