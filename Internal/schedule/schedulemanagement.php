...
$query_Recordset1 = 
"SELECT * FROM drama d,schedule s, time_slot ts
...
<button name="Add" type="button" class="btn btn-success" id="Add">
    ...
    <a href="addschedule.php" rel="facebox"
    style="text-decoration:none">
    <button name="Add" type="button" class="btn btn-success" id="Add">
    <span class="glyphicon glyphicon-plus-sign"></span> Add Schedule</button></a></td>
  ...
  <tr>
    <td colspan="2">
   <p style="margin-top:10px; color:#006600;
    font-style:italic" align="center" id="msg">
    <?php
...
Records <?php echo ($startRow_Recordset1 + 1) ?> to <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> of <?php echo $totalRows_Recordset1 ?>
  ...
  <tr>
    ...
    &nbsp;</td>
    <td align="center">
      <a href="editschedule.php?schedule_id=<?php echo $schedule_id; ?>"><span class="glyphicon glyphicon-edit" title="Edit"></span></a>
      <a href="deletschedule.php?schedule_id=<?php echo $schedule_id; ?>" onClick="return del('Drama')">
