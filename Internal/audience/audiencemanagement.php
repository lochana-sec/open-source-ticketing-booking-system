...
if(isset($_POST['submit'])){
	...
	$v=explode(" ",$k);
	$f=$v[0];
$query_Recordset1 = "SELECT * FROM audience WHERE fname='$f'";	
}else{

$query_Recordset1 = "SELECT * FROM audience ORDER BY audience_id DESC";
}
...
<div id="content">
<h4 align="center">Audience Management</h4>
...
<button name="Add" type="button" class="btn btn-success" id="Add">
    ...
    <form action="audiencemanagement.php" method="post">
    Search :
        ...
        id="aa">
      <button name="submit" type="submit" class="btn btn-success" id="sea">
...
Records <?php echo ($startRow_Recordset1 + 1) ?> to <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> of <?php echo $totalRows_Recordset1 ?>
    ...
    <!-- Drama Details -->
    <table border="0" align="center" width="90%" class="table table-condensed table-hover">
    <tr>
  <th>Audience ID</th>
    <th>Title</th>
    <th>First Name</th>
  ...
  <td align="center" valign="middle">
    ...
    <?php
		...
		echo $row_Recordset1['audience_id'];	
