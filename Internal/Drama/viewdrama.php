...
<table width="500px" border="0">
  ...
  <tr>
    ...
    <?php }else{?>
		<img src='../drama/drama_image/<?php echo $row['image']; ?>' width="75" height="auto" />
  ...
  <tr>
	...
	<source src="drama_video/<?php echo $row['video_clip']; ?>" type="video/mp4">
...
<source src="drama_audio/<?php echo $row['audio_clip']; ?>" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
