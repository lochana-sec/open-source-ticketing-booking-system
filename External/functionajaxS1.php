...
$sql1="SELECT * FROM drama d,schedule s,time_slot ts WHERE  d.drama_id=s.drama_id AND ts.time_slot_id=s.time_slot_id AND date='$s'";
...
?>
 ...
 <?php while ($row1=mysql_fetch_array($result1)){?><table width="500" border="0" class="table" style="color:black">
  <tr>
    <td rowspan="2">
